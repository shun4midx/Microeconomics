...
\pinkbox{Why do economists use models?}{
    Economists use \textbf{simplifying assumptions and models} to focus on the essential features of a complicated economy.
}

\noindent The diagram simplifes the economy down to two decision makers---firms and households---interacting in two markets. It \hlbf{leaves out government and international trade.}
...
\pinkbox{Summary}{
    Trade allows for mutual benefit due to \textbf{comparative advantages} comparing \textbf{opportunity costs}, instead of absolute advantages. Trade lets each country consume \textbf{outside its own PPF}, a combination of goods it could have never produced by itself.
}

\vspace{-1.0em}\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{imgs/ch03_tw_cam_ppf.png}
    \caption{Taiwan and Cambodia's PPF vs after trading}
    \label{fig:ch03_tw_cam_ppf}
\end{figure}

\pinkbox{Remark}{
    It is impossible for one country to have a comparative advantage in both goods, since the opportunity cost of one good is the inverse of the opportunity cost of another. A country that is relatively cheap at producing one good is automatically relatively expensive at producing the other.
}

\purplesec{Other Examples}

\begin{itemize}
    \item The surgeon and her assistant: A surgeon who can type faster than anyone else in her office should still hire an assistant to handle her scheduling and paperwork, since every hour she spends on typing is an hour she is not spending on surgery (i.e. opportunity cost of an hour of typing is far higher)
...
\purplesec{Shapes of PPFs}

\noindent PPFs are \textbf{straight lines} if a country \emph{switches} between producing its two goods at \hlbf{a constant rate}. \\

\noindent Real economies oftentimes have PPFs that \hlbf{bow outward} instead of running straight, where the \textbf{opportunity cost rises} the more a good is produced.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{imgs/ch03_ppf_comparison.png}
    \caption{Comparison of different PPF shapes}
\end{figure}
